...
contract HealthFactorLogicTest is Test {
    ...
    function testCalculateHealthFactor_NoDebt() public {
        ...
        assertEq(healthFactor, type(uint256).max, "Should return max health factor with no debt");
    }
    ...
    function testCalculateHealthFactor_HealthyPosition() public {
        ...
        assertEq(healthFactor, 1.9e18, "Should calculate correct health factor for healthy position");
    }
    ...
    function testCalculateHealthFactor_MultiAsset() public {
        ...
        assertEq(healthFactor, 2.65e18, "Should calculate correct health factor for multi-asset position");
    }

    function testCalculateHealthFactorWithModification_BorrowSimulation() public {
        // Set up existing position
        userSupplies[USER1][address(usdc)] = 1000e6;  // $1000 USDC
        userBorrows[USER1][address(usdc)] = 300e6;    // $300 USDC debt

        // Simulate borrowing additional $200 USDC
        uint256 newHealthFactor = HealthFactorLogic.calculateHealthFactorWithModification(
            USER1,
            address(usdc),
        ...
        // Expected: (1000 * 0.95) / 500 = 1.9
        assertEq(newHealthFactor, 1.9e18, "Should simulate health factor after borrow");
    }

    function testCalculateHealthFactorWithModification_WithdrawSimulation() public {
        // Set up existing position
        userSupplies[USER1][address(usdc)] = 1000e6;  // $1000 USDC
        ...
        assertEq(newHealthFactor, 1.9e18, "Should simulate health factor after withdraw");
    }
    ...
    function testCanBorrow_HealthyPosition() public {
        ...
        assertTrue(canBorrow, "Should allow borrowing with sufficient collateral");
    }
    ...
    function testCanBorrow_InsufficientCollateral() public {
        ...
        assertFalse(canBorrow, "Should reject borrowing with insufficient collateral");
    }

    function testCanBorrow_UnsupportedAsset() public {
        MockZRC20 unsupportedToken = new MockZRC20("Unsupported", "UNS", 18, 1000000 * 10**18);
    ...
    function testCanBorrow_InsufficientContractBalance() public {
        ...
        assertFalse(canBorrow, "Should reject borrowing when contract has insufficient balance");
    }
    ...
    function testCanWithdraw_HealthyPosition() public {
        ...
        assertTrue(canWithdraw, "Should allow withdrawal with sufficient remaining collateral");
    }
    ...
    function testCanWithdraw_InsufficientBalance() public {
        ...
        assertFalse(canWithdraw, "Should reject withdrawal exceeding user balance");
    }
    ...
    function testCanWithdraw_WouldViolateHealthFactor() public {
        ...
        assertFalse(canWithdraw, "Should reject withdrawal that would violate health factor");
    }
    ...
    function testIsLiquidatable_UnderLiquidationThreshold() public {
        ...
        assertTrue(liquidatable, "Position below liquidation threshold should be liquidatable");
    }
    ...
    function testIsLiquidatable_NoDebt() public {
        ...
        assertFalse(liquidatable, "Position with no debt should not be liquidatable");
    }
    ...
    function testGetMaxBorrowableUsd_HealthyPosition() public {
        ...
        assertEq(maxBorrowUsd, 600e18, "Should calculate correct max borrowable USD");
    }

    function testGetMaxBorrowableUsd_NoCollateral() public {
        uint256 maxBorrowUsd = HealthFactorLogic.getMaxBorrowableUsd(
            USER1,
            supportedAssets,
            userSupplies,
    ...
    function testGetMaxBorrowableUsd_OverBorrowed() public {
        ...
        assertEq(maxBorrowUsd, 0, "Should return zero when already over-borrowed");
    }
    ...
    function testGetMaxBorrowableAmount_USDC() public {
        ...
        // So max = 900 USDC
        assertEq(maxBorrowAmount, 900e6, "Should calculate correct max borrowable USDC amount");
    }
    ...
    function testGetMaxBorrowableAmount_ContractBalanceLimit() public {
        ...
        assertEq(maxBorrowAmount, 500e6, "Should be limited by contract balance");
    }

    // ==================== Health Factor Status Tests ====================

    function testGetHealthFactorStatus_Healthy() public {
    ...
    function testGetHealthFactorStatus_Risky() public {
    ...
    function testGetHealthFactorStatus_Liquidatable() public {
    ...
    function testGetHealthFactorStatus_NoDebt() public {
    ...
    function testGetHealthFactorImprovementNeeded_Healthy() public {
        uint256 healthyHF = 2e18;
        uint256 totalDebt = 1000e18;

        uint256 improvement = HealthFactorLogic.getHealthFactorImprovementNeeded(healthyHF, totalDebt);
        assertEq(improvement, 0, "Healthy position should need no improvement");
    }

    function testGetHealthFactorImprovementNeeded_NeedsImprovement() public {
        uint256 lowHF = 1.3e18; // 130%
        uint256 totalDebt = 1000e18;

        uint256 improvement = HealthFactorLogic.getHealthFactorImprovementNeeded(lowHF, totalDebt);

        // Current weighted collateral: 1.3 * 1000 = 1300
        // Needed weighted collateral: 1.5 * 1000 = 1500
        // Improvement needed: 1500 - 1300 = 200
        assertEq(improvement, 200e18, "Should calculate correct improvement needed");
    }

    function testGetHealthFactorImprovementNeeded_NoDebt() public {
        uint256 improvement = HealthFactorLogic.getHealthFactorImprovementNeeded(1e18, 0);
        assertEq(improvement, 0, "Should return zero improvement needed with no debt");
    }

    // ==================== Health Factor Improvement Validation Tests ====================

    function testValidateHealthFactorImprovement_ValidImprovement() public {
        uint256 oldHF = 1.1e18; // Below threshold
        uint256 newHF = 1.6e18; // Above minimum

        bool isValid = HealthFactorLogic.validateHealthFactorImprovement(oldHF, newHF);
        assertTrue(isValid, "Should validate sufficient health factor improvement");
    }

    function testValidateHealthFactorImprovement_InsufficientImprovement() public {
        uint256 oldHF = 1.1e18; // Below threshold
        uint256 newHF = 1.4e18; // Still below minimum

        bool isValid = HealthFactorLogic.validateHealthFactorImprovement(oldHF, newHF);
        assertFalse(isValid, "Should reject insufficient health factor improvement");
    }

    function testValidateHealthFactorImprovement_NoImprovement() public {
        uint256 oldHF = 1.1e18;
        uint256 newHF = 1.1e18; // Same as before

        bool isValid = HealthFactorLogic.validateHealthFactorImprovement(oldHF, newHF);
        assertFalse(isValid, "Should reject when health factor doesn't improve");
    }
    ...
    function testHealthFactor_VerySmallDebt() public {
        ...
        assertTrue(healthFactor > 1000e18, "Should handle very small debt correctly");
    }
