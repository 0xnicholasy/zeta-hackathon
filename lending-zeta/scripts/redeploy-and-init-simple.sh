...
hh run scripts/deposit-contract/deploy-deposit-contracts.ts simple --network arbitrum-sepolia      
hh run scripts/deposit-contract/simulate-deposit.ts --network arbitrum-sepolia
hh run scripts/deposit-contract/deploy-deposit-contracts.ts simple --network ethereum-sepolia
